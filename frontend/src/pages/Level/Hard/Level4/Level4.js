...
export default function Level4() {
  ...
  const [currentPose, setCurrentPose] = useState('Mayurasana')
      ...
      try {
        ...
        classification.array().then((data) => {
          ...
          if (data[0][classNo] > 0.97) {
            ...
            // Redirect to Level 5 when skeleton color is 'rgb(0,255,0)'
            if (skeletonColor === 'rgb(0,255,0)') {
              navigate('/hard/level/5') // Redirect to Level 5
            }
          } else {
            flag = false
