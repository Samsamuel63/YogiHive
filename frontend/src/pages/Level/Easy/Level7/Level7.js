...
export default function Level7() {
  ...
  const [currentPose, setCurrentPose] = useState('Shoulderstand')
    ...
    if (webcamRef.current?.video?.readyState === 4) {
      ...
      try {
        ...
        classification.array().then((data) => {
          ...
          // Redirect to Level 8 when skeleton color is 'rgb(0,255,0)'
