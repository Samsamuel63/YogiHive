...
export default function Level3() {
  ...
  const [currentPose, setCurrentPose] = useState('SuptaPadangusthasana'); // Example pose for Level 3
      ...
      try {
        ...
        classification.array().then((data) => {
          ...
          if (skeletonColor === 'rgb(0,255,0)') {
            navigate('/medium/level/4'); // Redirect to Level 4
          }
        });
      } catch (err) {
        console.error(err);
